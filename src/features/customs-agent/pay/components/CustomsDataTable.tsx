          ...
          {data.length === 0 ? (
            ...
            data.map((row) => {
              ...
              return (
                <TableRow 
                  key={row.id} 
                  className={isPaid ? 'bg-emerald-50/50 hover:bg-emerald-50/80' : 'hover:bg-slate-50/50'}
                >
                  ...
                  <TableCell className="text-right sticky right-0 bg-inherit border-l z-10">
                    <Button
                      ...
                      disabled={isPaying || isPaid || String(row.status).toLowerCase() !== 'success'}
                      className={
                        isPaid 
                    ...
                    >
                      ...
                      {isPaid ? 'Оплачено' : isPaying ? 'В процессе...' : 'Оплатить'}
                    </Button>
                  </TableCell>
                </TableRow>
              );
