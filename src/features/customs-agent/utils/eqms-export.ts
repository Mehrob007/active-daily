...
const EQMS_EXPORT_COLUMNS: ExportColumn[] = [
  { key: 'id', label: 'ID' },
...
type EqmsTransaction = Record<string, unknown>;

export const createEqmsWorkbook = (transactions: EqmsTransaction[]) => {
...
export const exportEqmsTransactions = (transactions: EqmsTransaction[], filename: string) => {
